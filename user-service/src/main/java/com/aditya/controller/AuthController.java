...
import com.aditya.payload.request.LoginDto;
import com.aditya.payload.request.SignupDto;
import com.aditya.payload.response.ApiResponse;
import com.aditya.payload.response.ApiResponseBody;
    ...
    public ResponseEntity<ApiResponse> HomeControllerHandler() {
        ...
        return ResponseEntity.status(
                ...
                .body(new ApiResponse(
                        ...
                        "welcome to aditya property booking system, user api"
